...
import { useRoute, useNavigation } from '@react-navigation/native'; // Import useRoute hook

const MediaScreen = (params) => {
    const route = useRoute();
    const navigation = useNavigation(); // Get navigation object

    const { itemId, type } = route.params; // Extract itemId and type from params
